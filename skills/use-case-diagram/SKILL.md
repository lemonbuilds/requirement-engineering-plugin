...
- Prefer actors on the left side of the diagram when the layout allows it
- Arrange use cases vertically from top to bottom where possible, following their declaration order in the diagram
